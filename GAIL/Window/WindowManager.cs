...
namespace GAIL.Window
{
	...
	public class WindowManager : IDisposable {
		...
		public void SetWindowPosition(int x, int y) {
			unsafe {
				API.Glfw.SetWindowPos(Window, x, y);
			}
		}
		...
		/// <summary>
        /// Whether the window has a top bar / edges.
        /// </summary>
		public unsafe bool Decorated {
			get {
				return API.Glfw.GetWindowAttrib(Window, WindowAttributeGetter.Decorated);
			}
			set {
				API.Glfw.SetWindowAttrib(Window, WindowAttributeSetter.Decorated, value);
			}
		}
		/// <summary>
        /// Whether the window is always on-top.
        /// </summary>
		public unsafe bool Floating {
			get {
				return API.Glfw.GetWindowAttrib(Window, WindowAttributeGetter.Floating);
			}
			set {
				API.Glfw.SetWindowAttrib(Window, WindowAttributeSetter.Floating, value);
			}
		}
