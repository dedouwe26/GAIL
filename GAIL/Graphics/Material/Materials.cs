...
namespace GAIL.Graphics.Material
{
    ...
    {
        public override void Apply(IShader shader) {
    ...
    //     /// <param name="viewMatrix">The position and rotation of the camera (offset).</param>
    //     /// <param name="projectionMatrix">The properties of the camera (far plane, near plane, FoV, etc).</param>
    //     public BasicMaterial(GraphicsManager manager, Color color, Texture? texture, Transform transform, Matrix4x4 viewMatrix, Matrix4x4 projectionMatrix) : this(manager, color, texture, transform.ToModelMatrix(), viewMatrix, projectionMatrix) { }
    // }
    // /// <summary>
